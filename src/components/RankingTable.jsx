    ...
    <table className="w-full text-xs sm:text-sm">
      <thead className="bg-[var(--hover)] text-left text-[var(--muted)]">
        <tr>
          ...
          <Th id="cravadas" className="hidden px-2 py-3 text-center font-medium sm:table-cell" title="Cravadas (placar exato)">🎯</Th>
          ...
          return (
            <Fragment key={r.participantId}>
              <tr onClick={() => setOpen(isOpen ? null : r.participantId)}
                ...
                <td className="hidden px-2 py-3 text-center font-semibold tabular-nums sm:table-cell">{r.cravadas || 0}</td>
