...
// pechinchas: nas seleções elite (top-8), MEI/LAT que ficaram em 3¢ viram 2¢
for(const pl of all){
  if(tierOf(pl.team)==="elite" && np.get(pl.id)===3 && (pl.position==="MEI"||pl.position==="LAT")) np.set(pl.id,2);
}
// Messi / CR7 / Neymar = 5¢
